...
$db_pass = ''; // Password
$db_name = 'messagedb'; // Database Name
...
<script>
	...
	<div id="header">
			...
			<ul class='dropdown-menu'> 
				...
				<li><a  href='mymessage.php'  class='active'><i class='fa fa-envelope'></i> Messages</a></li>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel"><font color="white"><span class='glyphicon glyphicon-trash' aria-hidden='true'></span> Delete Message</font></h4>
                        </div>
                        <div class="modal-body">
                            <form method="post" id="send4" action="mdelete.php">
							<div class="form-group">
								<label>Please enter the ID of the message you wish to remove:</label><br><br>
								<div class="input-group pb-modalreglog-input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                        ...
                        <div class="modal-footer">
							<button type="submit" class="btn btn-secondary" form="send4" > Submit</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
...
<div class="jumbotron" style="margin-bottom:-2px;">
		<div class="container">
<h3 class="sj2">Messages</h3>
	<table class="data-table">
		<caption class="title">Request and Feedbacks from Random users.<br /><br /><button class="btn btn-primary" data-dismiss='modal' data-toggle='modal' data-target='#myModal8' ><i class="fa fa-trash"></i> Delete message</button></caption>
		<thead>
			<tr>
				<th>ID</th>
				<th>Name</th>
