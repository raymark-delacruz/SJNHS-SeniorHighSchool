                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								...
								<div class="input-group pb-modalreglog-input-group">
								<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
								<input type="text" name="name" maxlength="15" placeholder="Type the new username here!" id="id3" class="form-control" required /> <br>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="input-group pb-modalreglog-input-group">
								<span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
								<input type="email" name="email" placeholder="Type the new email here!" id="id2" class="form-control" required  /> <br>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="input-group pb-modalreglog-input-group">
                                <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
								<input type="password" name="password" id="id4" placeholder="Type the new password here!" class="form-control" required />
								</div>
							</div>
							</form>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
							...
							<div class="form-group">
								<input type="hidden" type="text" name="role" value="student" class="form-control" required />
							</div>
							</form>
                        </div>
                        <div class="modal-footer">
...
<caption class="title"><span class='glyphicon glyphicon-stats' aria-hidden='true'></span> User's Status: &nbsp; &nbsp;0 = Offline, 1 = Online. <br><i class='fa fa-globe'></i> User's Grade: 0 = N/A.<br>
    ...
    $('.data-table').click(function() {
        if ($(buttonz).attr('disabled')) $(buttonz).removeAttr('disabled');
			...
			$con = mysql_connect("localhost","root","");
			mysql_select_db("ajaxdb",$con);
			$result = mysql_query("select count(1) FROM user");
			$row = mysql_fetch_array($result);
			$total = $row[0];
			echo "<h4>Total users: ".$total."</h4>";
			mysql_close($con);
			?>
		</caption>
		</center>
	...
	<table id="table" data-role="table" data-mode="columntoggle" class="data-table">
		...
		while ($row = mysqli_fetch_array($query))
		{
			echo "<tr class='click'>
					...
					<td style='display:none;' class='pass1'>".$row['user_password']."</td>
